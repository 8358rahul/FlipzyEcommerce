...
import { Alert, KeyboardAvoidingView, TextInput, TouchableOpacity, View } from 'react-native';
...
const InquiryForm: React.FC<InquiryFormProps> = ({ productId }) => {
  ...
  return (
    <KeyboardAvoidingView style={[styles.container,{backgroundColor:colors.card}]}>
      <ThemedText style={[styles.title,{color:colors.primary}]}>Have a Question?</ThemedText>
      ...
      <View style={styles.inputContainer}>
        ...
        <Controller
          ...
          render={({ field: { onChange, onBlur, value } }) => (
            <TextInput
              style={[styles.input, errors.name && styles.errorInput,{color:colors.text,backgroundColor:colors.card,borderColor:colors.border}]}
      ...
      <View style={styles.inputContainer}>
        ...
        <Controller
          ...
          render={({ field: { onChange, onBlur, value } }) => (
            <TextInput 
                style={[     styles.input,
                styles.messageInput,
                errors.message && styles.errorInput,,{color:colors.text,backgroundColor:colors.card,borderColor:colors.border}]}
              placeholderTextColor={colors.placeholderTextColor}
        ...
        />
        {errors.message && (
          <ThemedText style={styles.errorText}>{errors.message.message}</ThemedText>
        )}
      </View>
